          ...
          <div className="flex flex-col gap-3 border-t border-stone-100 bg-white px-6 py-4 shadow-lg md:hidden">
            ...
            <div className="flex gap-3 border-t border-stone-100 pt-4">
              <button
                type="button"
                onClick={openAuthDialog}
                className="flex-1 rounded border border-stone-200 py-3 text-center text-xs font-semibold uppercase tracking-widest text-stone-600 transition-colors hover:text-[#D8C97B]"
              >
